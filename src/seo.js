...
const baseSeoRoutes = [
  ...
  route('/work/portfolio-6', 'ECHO Blockchain Ticketing - HyyAnk', 'A visual-first blockchain ticketing case study spanning naming, identity, ticket transfer, venue check-in and attendance records.', 'src/assets/case-studies/echo-vn-hero.webp', 'article'),
