...
export const seoRoutes = [
  ...
  route('/work/still-moving', 'HUAXINSHENG - HyyAnk', 'A 24-page Vietnamese company catalogue for welded steel mesh, covering company capability, production, engineering standards, applications and projects.', 'src/assets/case-studies/hxs-01.webp', 'article'),
  route('/work/kitepay', 'RELAY - HyyAnk', 'A blockchain event-ticketing product for verified ownership, simple transfer, capped resale and fraud-resistant gate entry.', 'src/assets/case-studies/relay-cover.webp', 'article'),
