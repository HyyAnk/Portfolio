...
export const seoRoutes = [
  ...
  route('/work/portfolio-1', 'DẤU - HyyAnk', 'A visual archive for scanning Vietnamese craft motifs and discovering artifact context, maker stories and regional techniques.', 'src/assets/case-studies/dau-cover.webp', 'article'),
  route('/work/portfolio-2', 'VỤN - HyyAnk', 'An original identity system for a circular-material studio, spanning samples, packaging, space and digital catalogue.', 'src/assets/case-studies/vun-cover.webp', 'article'),
  route('/work/portfolio-3', 'HUAXINSHENG - HyyAnk', 'A 24-page Vietnamese company catalogue for welded steel mesh, covering company capability, production, engineering standards, applications and projects.', 'src/assets/case-studies/hxs-home-cover.webp', 'article'),
  route('/work/portfolio-4', 'RELAY - HyyAnk', 'A blockchain event-ticketing product for verified ownership, simple transfer, capped resale and fraud-resistant gate entry.', 'src/assets/case-studies/relay-cover.webp', 'article'),
  route('/work/portfolio-5', 'HAI LONG Presentation - HyyAnk', 'A 43-slide English corporate construction presentation covering company credentials, production capability, completed projects and HSE.', 'src/assets/case-studies/hailong-cover.webp', 'article'),
  route('/work/portfolio-6', 'TAIYO TOURIST Envelope - HyyAnk', 'A three-format branded envelope and travel-document handover system for Taiyo Tourist, including artwork, print construction and physical mockups.', 'src/assets/case-studies/taiyo-cover.webp', 'article'),
