...
const works = [
  ...
  { slug: 'portfolio-2', caseKey: 'mat', title: 'DẤU', type: 'Cultural archive · Web app', year: '2026', role: 'Product strategy · UX/UI', description: 'A visual archive for scanning Vietnamese craft motifs and finding the people, places and techniques behind them.', challenge: 'Cultural records are often detached from the object and difficult to explore during a real museum or workshop visit.', outcome: 'A responsive archive connecting recognition, artifact context, maker audio, collections and offline access.', tags: ['Product design', 'Cultural archive'], image: dauCover, deep: true },
